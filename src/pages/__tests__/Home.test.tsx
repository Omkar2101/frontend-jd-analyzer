...
let mockResultData: MockResultData | null = null
...
describe('Home', () => {
  ...
  it('shows info toast when starting file analysis', async () => {
    ...
    // Mock successful API response - Add a small delay to simulate real API behavior
    ...
    // Wait for info toast to be called - increased timeout and more specific check
    await waitFor(() => {
      expect(toast.info).toHaveBeenCalledWith(
        'Processing and analyzing file...', 
        { 
          autoClose: 1000, 
          hideProgressBar: true 
        }
